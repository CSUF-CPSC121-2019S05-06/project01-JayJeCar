...
Design your `main` function so that it asks the user to choose between creating a note or exiting the program. It should call the `add_question` function when the user asks to create a question and exits otherwise. Also, display the error message accordingly.
